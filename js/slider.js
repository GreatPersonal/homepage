 ...
 var $wrap=$("#wrap"),
	    ...
	    var resize=function(){
	      ...
	      $moreNav.height(h);
	      // if(w/h<1920/1080){
	        // $bgs.height().css({width:"auto",margin:-.5*h+"px 0 0 "+-.5*1920/1080*h+"px"});
	      // }else{
	        $bgs.css({width:"100%",height:"auto"});
	      // }
	      var imgH=$bgs.height();
	      ...
	      if(isCss3){
	        ...
	        switch(true){
	          ...
	          case w<1600&&w>=1536:{cls="small8";break;}
	          case w<1536&&w>=1440:{cls="small8";break;}
	          case w<1440&&w>=1366:{cls="small8";break;}
	          case w<1366&&w>=1280:{cls="small8";break;}
	          case w<1280&&w>=1024:{cls="small8";break;}
	          case w<1024:{cls="small8";break;}
	        }
	        ...
	        switch(true){
	          ...
	          case w<1600&&w>=1440:{cls="big_view";break;}
	          case w<1440:{cls="big_view";break;}
	        }
	        var ws=$wrap[0].className;
	        if(isIE6&&(ws.indexOf("big")!=-1)&&ws.indexOf(cls)==-1)
	          location.reload();
